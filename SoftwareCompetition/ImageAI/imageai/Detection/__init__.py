                ...
                if (self.__modelType == "retinanet"):
                    ...
                    while (input_video.isOpened()):
                        ...
                        if (ret == True):
                            ...
                            person_cake_coordinate_file = open(
                                os.path.join(execution_path, 'frames/training/training_coordinates.txt'), 'a')
                            ...
                            ########## 추가한 부분 ##########
                            person_cake_coordinate_file.write(str(output_objects_array) + '\n')
                            person_cake_coordinate_file.close()
                            #################################
        ...
        if (input_file_path == "" and camera_input == None):
            ...
            try:
                if (self.__modelType == "retinanet"):
                    ...
                    if not os.path.isdir(execution_path + '/coordinate/'):
                        os.mkdir(execution_path + '/coordinate/')
                    #################################
                    ...
                    while (input_video.isOpened()):
                        ...
                        if (ret == True):
                            ...
                            ########## 추가한 부분 ##########
                            person_cake_coordinate_file = open(
                                os.path.join(execution_path, 'coordinate/cctv.txt'), 'a')
